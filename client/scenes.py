...
import pygame
# from client.elements import Line
...
class MainMenuScene(BaseScene):
    ...
    def __init_all_buttons(self):
        ...
        create_room_button = Button(
            self._display_surface, button_x_pos, 50, button_width, button_height, 'Create room')
        ...
        join_room_button = Button(
            self._display_surface, button_x_pos, 350, button_width, button_height, 'Join room')
        join_room_button.set_click_handler(self.__handle_join_room)
        self.__buttons.append(join_room_button)

        exit_game_button = Button(
            self._display_surface, button_x_pos, 650, button_width, button_height, 'Exit game')
...
class JoinRoomScene(BaseScene):
    ...
    def __init_all_buttons(self):
        ...
        join_button = Button(
            self._display_surface, button_x_pos, 300, self.__button_width, self.__button_height, 'Join')
        join_button.set_click_handler(self.__handle_join)
        self.__buttons.append(join_button)

        back_button = Button(
            self._display_surface, button_x_pos, 500, self.__button_width, self.__button_height, 'Back')
        back_button.set_click_handler(self.__handle_back)
        self.__buttons.append(back_button)
...
class InGameScene(BaseScene):
    ...
    def __init_grids(self):
        line1 = Grid(self._display_surface, 0, 300, 900, 300, 10)
        self.__lines.append(line1)
        line2 = Grid(self._display_surface, 0, 600, 900, 600, 10)
        self.__lines.append(line2)
        line3 = Grid(self._display_surface, 300, 0, 300, 900, 10)
        self.__lines.append(line3)
        line4 = Grid(self._display_surface, 600, 0, 600, 900, 10)
